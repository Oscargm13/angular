...
export class ServiceDepartamentos{
  ...
  getDepartamentos(): Observable<any> {
    ...
    return this._http.get("https://apiejemplos.azurewebsites.net/api/departamentos");
  }
  ...
  deleteDepartamento(idDepartamentos: string): Observable<any> {
    let request = "api/departamentos/" + idDepartamentos;
    let url = environment.departamentos + request;
